document.addEventListener("DOMContentLoaded", () => {
    ...
    const playList = [
        { title: "Symphony", name: "Clean Bandit ft. Zara Larsson", source: "/assests/Music/Music 1.mp3" },
        { title: "Pawn It All", name: "Alicia Keys", source: "/assests/Music/Music 2.mp3" },
        { title: "Seni Dert Etmeler", name: "Madrigal", source: "/assests/Music/Music 3.mp3" },
        { title: "Instant Crush", name: "Daft Punk ft. Julian Casablancas", source: "/assests/Music/Music 4.mp3" },
        { title: "As It Was", name: "Harry Styles", source: "/assests/Music/Music 5.mp3" },
        { title: "Physical", name: "Dua Lipa", source: "/assests/Music/Music 6.mp3" },
        { title: "Delicate", name: "Taylor Swift", source: "/assests/Music/Music 7.mp3" },
    ];
